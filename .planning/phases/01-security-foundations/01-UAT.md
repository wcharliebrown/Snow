...
number: 7
name: Admin Logs page shows structured entries
expected: |
  Navigate to /admin/logs. The table should show recent entries with columns:
  Timestamp, Level (badge), Event Type, User (name or System), IP Address, Message.
  At minimum you should see login-related INFO entries from your recent login.
